...
str(NTL.phys.data)
#sample data recorded as character. need to fix
dim(NTL.phys.data)
...
#dont need to worry about century cutoff
...
#useful when you want to filter multiple selections but dont want to type lakename over and over again
...
NTL.phys.data.Tuesday90_99 <- filter(NTL.phys.data, year4 >= 1990 & year4 <= 1999, lakename == "Tuesday Lake")
...
#second option better way to go about it 
