...
PeterPaulplot1 <-  ggplot(subset(PeterPaul.chem.nutrients, depth == 0), aes(x=daynum, y = temperature_C, color = year4))+
...
Peterpaulplot2 <- ggplot(PeterPaul.chem.nutrients, aes(x = sampledate, y = temperature_C, color = depth))+
  geom_point(size = 0.5)+
...
Plot3 <- ggplot(EPAair, aes(x = PM2.5, y=Ozone, color = meanlatitude))+
