...
list1[[2]]
list1$mynumbers
#two ways of retrieving things from a list 
...
HighTempF <- c(44,50,33,43,51,54,59,66,57,42)
LowTempF <- c(27,27,15,25,26,35,47,53,30,22)
...
HighTempC <- Celsius(HighTempF)
LowTempC <- Celsius(LowTempF)
...
df <- data.frame(HighTempF, LowTempF, HighTempC, LowTempC)
