...
# Notice that other lake names didn't go away, even though they have zero values. Have to use droplevels function to only show Peter and Paul lakes in summary 
