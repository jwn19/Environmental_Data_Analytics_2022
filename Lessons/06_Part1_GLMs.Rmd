...
#preferred way since dont have to type out dataset repeatedly
...
#divides plot window into 2x2, second part is for sizes
plot(irradiance.regression)
#first plot, looking for symmetry based on red line and want red line to be as flat as possible
#for QQ, dashed line is for normal distribution, want black circle to fall within dashed lines, lower ends and higher ends may deviate a little, does not necessarily mean residuals are not normal
#third plot, looking for symmetry again 
#
par(mfrow = c(1,1))
```
