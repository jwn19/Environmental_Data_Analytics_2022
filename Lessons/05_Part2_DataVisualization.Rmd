...
#lty refers to what type of line (ie. dashed)
# alpha refers to transparency 
#hjust means margin to consider - 1 means left align
...
#rel heights, if one plot needs more space than the other 
